...
/**
 * GameModeManager implements a stack of user-specific <i>game modes</i>. Modes can be pushed on to
 ...
 * Usage example:
 * <pre>
 *   var mgr :GameModeManager = new GameModeManager(switchDisplayFn);
...
public class GameModeManager 
{
     ...
     */
    public function GameModeManager (callback :Function)
    {
        _callback = callback;
    }
